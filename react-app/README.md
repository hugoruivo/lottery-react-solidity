...
Start by deploying the smart contract in the ../lottery-contract folder then update lottery.js file with the interface code and the contract address:

```
//Update with your deployed contract address
const address = '<YOUR_CONTRACT_ADDRESS>';

//If you make changes to the contract update this after deploying it
const abi = ...;
```
